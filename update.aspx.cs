...
public partial class update : System.Web.UI.Page
{
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        {
            con.Open();
            string query = "Update [user] set age=@age,religion=@religion,tougue=@tougue,weight=@weight,status=@status,located=@located,interested=@interested,bloodgrp=@bloodgrp,complexion=@complexion,education=@education,annual=@annual,mobile=@mobile,img=@img where id='" + Label2.Text.Trim() + "'";
